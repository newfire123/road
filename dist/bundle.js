var CrossRoad = (() => {
  ...
  function updateScale() {
    ...
    const ratio = isPortrait ? 0.7 : 0.9;
    ...
    const vvText = window.visualViewport ? `vv: ${window.visualViewport.width.toFixed(0)}x${window.visualViewport.height.toFixed(0)} off ${window.visualViewport.offsetLeft.toFixed(1)},${window.visualViewport.offsetTop.toFixed(1)}` : "vv: n/a";
